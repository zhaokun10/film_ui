  ...
  <div style="margin-left: 200px">
    ...
    <el-card>
      ...
      <el-table :data="pageTicket" border stripe>
        ...
        <el-table-column label="电影类别" prop="typeName"></el-table-column>
    ...
    >
      ...
      <el-form
          ...
          label-width="70px"
      >
        <el-form-item label="电影类别" prop="typeName">
...
export default {
  ...
  methods: {
    ...
    handlesearch: function () {
      this.pageTicket = this.newTypeList.filter(item => {
    ...
    getPageInfo() {
      ...
      for (let i = (this.currentPage - 1) * this.pageSize; i < this.total; i++) {
        ...
        this.pageTicket.push(this.newTypeList[i]);
    ...
    addType() {
      ...
      this.$refs.addFormRef.validate(async valid => {
        if (!valid) return
        // 可以发起添加用户的网络请求
        this.$axios.post("/type/addType", this.addForm).then(ref => {
    ...
    async showEditDialog(id) {
      this.$axios.get("/type/findTypeByTypeId?typeId=" + id).then(ref => {
    ...
    editUserInfo() {
      ...
      this.$refs.editFormRef.validate(async valid => {
        ...
        this.$axios.post("/type/updateType", this.editForm).then(ref => {
          if (ref.status !== 200) {
    ...
    async removeUserById(id) {
      ...
      // 发送删除请求
      this.$axios.post("/type/deleteType", id).then(ref => {
